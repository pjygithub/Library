...
<body style="margin-left:0%;margin-top:0px;height:auto;width:145%;">
          <form class="form-inline" name="form1" method="post" action="">
          <table bordercolor="#FFFFFF" bgcolor="#9ECFEE" style="margin-top:0px;font-size:15px;">
...
?>   
<table class="table table-hover" style="display:block;width:83%;margin-top:0px;font-size:15px;text-align: center;right:1%;left:17%">
	<thead style="text-align: center;width:80%;">
		<tr  bgcolor="#E6E6FA" style="text-align: center;width:100%;">
			<th style="width:">条形码ISBN</th>
      <th style="width:">图书题名</th>
      <th style="width:6%">作者</th>
      <th style="width:5%">译者</th>
      <th >出版社</th>
      <th style="width:6%">索书号</th>
      <th style="width:5%">页码数</th>
      <th style="width:5%">价格:元</th>
      <th >类型</th>
      <th style="width:10%">大小</th>
      <th style="width:5%">印张</th>
      <th style="width:5%">字数:千字</th>
      <th style="width:5%">总库存:本</th>
      <th style="width:5%">流通状态</th>
		</tr>
	</thead>
	<tbody>
