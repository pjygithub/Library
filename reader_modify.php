...
<form name="form1" method="post" action="reader_modifyok.php" class="form-horizontal">
	...
	<div>&nbsp;&nbsp;&nbsp;
 <input style="width:3%" name="sex" type="radio" class="radio-inline" id="radiobutton"  value="男" <?php if($result["sex"]=="男"){?> checked <?php }?>>男

	<input style="width:3%" name="sex" id="radiobutton" type="radio" class="radio-inline" value="女" <?php if($result["sex"]=="女") {?> checked <?php }?>>女
</div>
	</div>
	<div class="form-group">
