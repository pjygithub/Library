...
<body style="margin-left:18%;margin-top:10%;height:50%;width:80%">
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			<button name="submit" type="submit" class="btn btn-primary" onClick="check(form1)" value="确认注册">确认注册</button>
			<button name="Submit2" id="Submit2" type="button" class="btn btn-danger" value="放弃注册" onClick="history.back();">放弃注册</button>
		</div>		
	</div>
